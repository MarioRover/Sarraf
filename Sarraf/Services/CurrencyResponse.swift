...
struct CurrencyResponse {
    ...
    init(currencyStruct: CurrencyStruct, responseType: String) {
        
        switch responseType {
        case Constant.CurrencyKind.currency:
        ...
        case Constant.CurrencyKind.gold:
        ...
        case Constant.CurrencyKind.virtual:
